...
| Image Generation | `IMAGE_SEEDREAM_API_KEY`, `IMAGE_QWEN_IMAGE_API_KEY`, `IMAGE_NANO_BANANA_API_KEY`, `IMAGE_MINIMAX_API_KEY`, `IMAGE_GROK_API_KEY`, `IMAGE_LIBLIB_API_KEY` | Generates images for slides (any one suffices) |
