...
class Abp60PqPbqPqcApb150Problem(Scene):
    def construct(self):
        ...
        # Step 2: 构造旋转
        self.add_sound(r'output_problem4/audio/narration_002.mp3', time_offset=0.00)
        if len(current_formula_group) > 0:
            self.play(FadeOut(current_formula_group), run_time=0.20)
        current_formula_group = VGroup()
        step_formula_group = VGroup()
        ...
        # Step 3: 正三角形判定
        self.add_sound(r'output_problem4/audio/narration_003.mp3', time_offset=0.00)
        if len(current_formula_group) > 0:
            self.play(FadeOut(current_formula_group), run_time=0.20)
        current_formula_group = VGroup()
        step_formula_group = VGroup()
        ...
        # Step 4: 直角三角形性质
        self.add_sound(r'output_problem4/audio/narration_004.mp3', time_offset=0.00)
        if len(current_formula_group) > 0:
            self.play(FadeOut(current_formula_group), run_time=0.20)
        current_formula_group = VGroup()
        step_formula_group = VGroup()
